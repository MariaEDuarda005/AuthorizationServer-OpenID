...
public class ClientController {
    ...
    // endpoint para o servidor de recursos
    @GetMapping("tasks")
    public Mono<String> getTasks(
            @RegisteredOAuth2AuthorizedClient OAuth2AuthorizedClient client
    ){
        // utilizar o webClient para fazer o acesso
        return webClient
                .get()
                .uri("tasks")
                // no header passa o auth e o token de acesso que pega passando o RegisteredOAuth2AuthorizedClient
